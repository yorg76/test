	...
	<div class="col-md-3">
		<ul class="ver-inline-menu tabbable margin-bottom-10">
			<li class="active">
				...
				<i class="fa fa-cog"></i>Nowa kategoria magazynowania</a>
				<span class="after">
				</span>
			</li>
				...
				<div id="tab_1-1" class="tab-pane active">
					...
					<div class="form-group">
						...
						<div class="input-icon right">
							<input type="text" placeholder="Nazwa kategorii" class="form-control" name="name" value="" />
					...
					<div class="form-group">
						...
						<textarea class="form-control" placeholder="Opis kategorii" name="description">
						</textarea>
						<span class="help-block"></span>
					</div>
					<br/>
