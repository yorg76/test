<div class="row profile-account">	
	...
	<div class="col-md-9">
		<form enctype="multipart/form-data" role="form" action="/warehouse/document_remove/<?php echo $bulkpackaging->id; ?>" method="POST" id="remove_bulkpackaging_form">
			...
			<div class="tab-content">
				...
				<div id="tab_1-1" class="tab-pane active">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="description"><?php echo $bulkpackaging->description; ?>
						</textarea>
						<span class="help-block"></span>
					</div>
