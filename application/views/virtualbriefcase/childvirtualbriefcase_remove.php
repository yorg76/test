<div class="row profile-account">	
	<div class="col-md-3">
		<ul class="ver-inline-menu tabbable margin-bottom-10">
			<li class="active">
				...
				<i class="fa fa-cog"></i>Usuwanie wirtualnej teczki <?php echo $documentlist->name; ?> z wirtualnej teczki</a>
				<span class="after">
				</span>
			</li>
	...
	<div class="col-md-9">
		<form enctype="multipart/form-data" role="form" action="/virtualbriefcase/childvirtualbriefcase_remove/<?php echo $childvirtualbriefcase->id; ?>" method="POST" id="remove_childvirtualbriefcase_form">
				...
				<div id="tab_1-1" class="tab-pane active">
					<div class="form-group">
						...
						<div class="input-icon right">
							<input type="text" placeholder="Nazwa" class="form-control" name="name" value="<?php echo $childvirtualbriefcase->name; ?>" DISABLED/>
