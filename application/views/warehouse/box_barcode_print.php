<div class="row profile-account">	
	...
	<div class="col-md-9">
		<form role="form" action="/warehouse/box_barcode_print" method="POST" id="edit_place_form" target="barcodes_frame">
			...
			<div class="tab-content">
				...
				<div id="tab_1-1" class="tab-pane active">
					...
					<iframe src="" name="barcodes_frame" width="380" height="280">
					</iframe>
					
										
					<br />
					<div class="margiv-top-10">
						<button href="/warehouse/box_barcode_print" class="btn green" id="submit" onClick="javascript:submit();">
