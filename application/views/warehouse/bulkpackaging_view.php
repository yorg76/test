				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-pencil"></i>Opakowanie zbiorcze: <?php echo $bulkpackaging->name ?> - Dokumenty
							</div>
							<div class="tools">
							...
							<tr>
								...
								<td style="width:20%">
									<div class="margin-bottom-5">
											...
											<button class="btn btn-xs red division-remove margin-bottom" onClick="javascript:window.location='/warehouse/document_remove/<?php echo $document->id ;?>';"><i class="fa fa-recycle"></i> Usuń z opakowania</button>
									</div>
								</td>
							</tr>
							<?php endforeach;?>
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-pencil"></i>Opakowanie zbiorcze: <?php echo $bulkpackaging->name ?> - Listy Dokumentów
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
							...
							<tr>
								...
								<td style="width:20%">
									<div class="margin-bottom-5">
											...
											<button class="btn btn-xs red division-remove margin-bottom" onClick="javascript:window.location='/warehouse/documentlist_remove/<?php echo $documentlist->id ;?>';"><i class="fa fa-recycle"></i> Usuń z opakowania</button>
									</div>
								</td>
							</tr>
							<?php endforeach;?>
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-pencil"></i>Opakowanie zbiorcze: <?php echo $bulkpackaging->name ?> - Opakowania zbiorcze
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
							...
							<tr>
								...
								<td style="width:20%">
									<div class="margin-bottom-5">
											...
											<button class="btn btn-xs red division-remove margin-bottom" onClick="javascript:window.location='/warehouse/bulkpackaging_remove/<?php echo $bulkpackaging->id ;?>';"><i class="fa fa-recycle"></i> Usuń z opakowania</button>
									</div>
								</td>
							</tr>
							<?php endforeach;?>
