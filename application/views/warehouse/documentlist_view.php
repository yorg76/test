	...
	<div class="col-md-12">
		...
		<div class="portlet box grey">
			<div class="portlet-title">
				<div class="caption">
					<i class="glyphicon glyphicon-list-alt"></i>Lista dokumentów <?php echo $documentlist->name ?> - Dokumenty
							</div>
				<div class="tools">
					...
					<tbody>
							...
							<td>
								<div class="margin-bottom-5">
									...
									<button class="btn btn-xs red margin-bottom"
										onClick="javascript:window.location='/warehouse/document_remove/<?php echo $document->id ;?>';">
										<i class="fa fa-recycle"></i> Usuń z listy
									</button>
								</div>
							</td>
						</tr>
