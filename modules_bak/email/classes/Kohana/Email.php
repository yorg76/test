...
class Kohana_Email {
	...
	public function sign()
	{
		...
		if(isset($options['private_key_pass']) && $options['private_key_pass'] != NULL ) { 
		    $smimeSigner->setSignCertificate($options['certificate'],array($options['private_key'],$options['private_key_pass']));
		}else {
		    $smimeSigner->setSignCertificate($options['certificate'],$options['private_key']);
		    
		}
		
		$this->_message->attachSigner($smimeSigner);
